...
public class StringUtil {
	...
	public static String collectionToStr(Collection<?> collection, char separator){
		return collectionToStr(collection, separator, null, null, true);
	}
	
	public static String collectionToStr(Collection<?> collection, char beginBlock, char endBlock){
		return collectionToStr(collection, null, beginBlock, endBlock, true);
	}
	
	public static String collectionToStr(Collection<?> collection, char separator, char beginBlock, char endBlock){
		return collectionToStr(collection, separator, beginBlock, endBlock, true);
	}
	
	public static String collectionToStr(Collection<?> collection, Character separator, Character beginBlock, Character endBlock, boolean useConvert){
