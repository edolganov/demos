...
import static demo.util.log.LogUtil.*;
import static java.util.Collections.*;
import demo.util.exception.BreakLoopException;
import demo.util.exception.ContinueLoopException;
	...
	public static <T extends Enum<T>> T tryGetEnumByCode(Integer code, Class<T> enumType, T defaultVal){
		...
		try {
			for (T c : enumType.getEnumConstants()) {
				int curCode = ((demo.util.model.HasIntCode)c).getCode();
