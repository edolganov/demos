...
//from org.apache.commons.collections.buffer
/**
 ...
 * @author Herve Quiroz
 */
public class BoundedFifoBuffer<T> extends AbstractCollection<T> {
     ...
     */
    public BoundedFifoBuffer(Collection<T> coll) {
        this(coll.size());
        addAll(coll);
    }
	...
	public boolean add(Object element) {
        ...
        if (full) {
            throw new IllegalStateException("The buffer cannot hold more than " + maxElements + " objects.");
        }
