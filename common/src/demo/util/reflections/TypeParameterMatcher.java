 ...
 * <pre>
 * class SomeClass<I>{}	
 * TypeParameterMatcher matcher = TypeParameterMatcher.find(this, SomeClass.class, "I");
 * 
 * public boolean acceptType(Object ob) throws Exception {
 *   return matcher.match(ob);
 * }
 * </pre>
 */
